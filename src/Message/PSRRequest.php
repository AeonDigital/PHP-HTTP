...
class PSRRequest implements RequestInterface
{
    ...
    {
        return $this->mainObj->getProtocolVersion();
    }
    ...
    {
        return $this->mainObj->withProtocolVersion($version)->toPSR();
    }
    ...
    {
        return $this->mainObj->getHeaders();
    }
    ...
    {
        return $this->mainObj->hasHeader($name);
    }
    ...
    {
        return $this->mainObj->getHeader($name);
    }
    ...
    {
        return $this->mainObj->getHeaderLine($name);
    }
    ...
    {
        return $this->mainObj->withHeader($name, $value)->toPSR();
    }
    ...
    {
        return $this->mainObj->withAddedHeader($name, $value)->toPSR();
    }
    ...
    {
        return $this->mainObj->withoutHeader($name)->toPSR();
    }
    ...
    {
        return $this->mainObj->getBody()->toPSR();
    }
    ...
    {
        return $this->mainObj->withBody($body)->toPSR();
    }
