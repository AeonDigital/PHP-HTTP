...
use AeonDigital\Http\Data\UploadedFileCollection as UploadedFileCollection;
...
class UploadedFileCollectionTest extends TestCase
{
    ...
    {
        $files = new UploadedFileCollection();
        $this->assertTrue(is_a($files, UploadedFileCollection::class));
    }
    ...
    public function test_constructor_ok_with_values()
    {
        ...
        $f1 = prov_instanceOf_Http_UploadedFile($fs1);
        $fs2 = prov_instanceOf_Http_FileStream_fromFile("upload-image-2.jpg");
        $f2 = prov_instanceOf_Http_UploadedFile($fs2);
    ...
    {
        $ckie = new UploadedFileCollection(["key1" => "value1"]);
    ...
    public function test_method_get()
    {
        ...
        $files = prov_instanceOf_Http_UploadedFileCollection_01(
            ["file1" => $f1, "file2" => $f2, "file3" => null]
        );
